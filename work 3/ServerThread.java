...
public class ServerThread implements Runnable {
    ...
    /**
     * Creates the serverThread object with required parameters
     *
     * @param socket the socket between the server and client
     * @param usrBank conducts operations on user data
     * @param postsBank conducts operation on post data
     */
    ...
    /**
     * Runs the server thread reading and writing to the client
     */
    public void run() {
        try {
            while (true) {
    ...
    /**
     * Interprets the message recieved from the client and conducts operations requested using userbank and postsbank
     *
     * @param message raw message recieved from server
     * @return The response the server needs to send back to the client
     */
